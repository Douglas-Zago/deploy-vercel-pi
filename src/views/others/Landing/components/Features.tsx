...
const Features = ({ mode, onModeChange, schema, setSchema }: FeaturesProps) => {
    ...
    return (
        <div id="features" className="relative z-20 py-24 md:py-32 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
            <Container>
                <motion.div
                ...
                >
                    <motion.h2 className="my-6 text-5xl">
                        Tudo que Você Precisa no Portal SAGE
                    </motion.h2>
                    <motion.p className="mx-auto max-w-[600px]">
                        Uma plataforma completa para gerenciar toda sua vida escolar com inteligência, segurança e simplicidade
                    </motion.p>
                </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        Mude entre modo claro e escuro ou crie seu próprio tema
                                    </p>
                                </div>
                            </Card>
                            <Card
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        Guias detalhados para ajudá-lo a começar e dominar a plataforma
                                    </p>
                                </div>
                            </Card>
                        </div>
                        <div className="mt-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        Escolha entre várias opções de layout para atender suas necessidades. Oferecemos flexibilidade para qualquer estilo de design ou idioma.
                                    </p>
                                </div>
                            </Card>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">
                                        Componentes Tailwind Artesanais
                                    </h4>
                                    <p className="mt-2">
                                        Uma coleção de componentes Tailwind altamente flexíveis que se adequam a qualquer caso de uso
                                    </p>
                                </div>
                            </div>
                        </Card>
